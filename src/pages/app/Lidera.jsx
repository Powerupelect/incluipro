  ...
  return (
    <div>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        {kits.map((kit) => (
          <div key={kit.tema} className="relative flex flex-col rounded-lg border border-mist-300 bg-white p-6">
            {kit.novo && (
            ...
            <a
              href={kit.arquivo}
              download
              className="mt-5 inline-flex items-center justify-center gap-2 rounded-md bg-indigo-700 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-indigo-800"
            >
      ...
      <div className="mt-8 flex items-start gap-4 rounded-lg border border-volt-200 bg-volt-50 p-6">
